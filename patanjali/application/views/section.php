...
<div class="container-fluid">
            ...
            <div class="row" style="text-align:center;">
                ...
                <div class="span2" style="border:4px solid #1AB255;">
                    <a href="#"><div class="icons-box" >
                        <i style="color:red" class="circle big"><img src="<?php echo base_url();?>assets/img/admission.png" alt="Rural Urban Council of Skills & Vocational Studies"></i>
                ...
                <div class="span2" style="border:4px solid #1AB255;margin-left:0px">
                    <a href="#"><div class="icons-box" >
                        <i style="color:red" class="circle big3"><img src="<?php echo base_url();?>assets/img/online.png" alt="Rural Urban Council of Skills & Vocational Studies"></i>
            ...
            <img src="<?php echo base_url();?>assets/img/beti.png" style="height:120px"/>
            
            </div>
            <div class="span2" style="background-color:white;text-align:center">
            <img src="<?php echo base_url();?>assets/img/beti2.png" style="height:120px"/>
            
            </div>
            <div class="span2" style="background-color:white;text-align:center">
            <img src="<?php echo base_url();?>assets/img/skill.png" style="height:120px"/>
            
            </div>
            <div class="span3" style="background-color:white;text-align:center">
            <img src="<?php echo base_url();?>assets/img/shiksha.jpg" style="height:120px"/>
            
            </div>
            <div class="span3" style="background-color:white;text-align:center">
            <img src="<?php echo base_url();?>assets/img/swach.jpg" style="height:120px"/>
            ...
            <div class="span8" style="background-color:white;">
                    <div class="row" style="margin:5px;background-color:white;;margin-bottom:20px;border: 2px solid green;border-radius: 7px;">
        <h3 style="color:white;text-align:center;border-radius: 5px;margin:0px" class="mycolor2">Downloads / Updates Links</h3>
        ...
        <div class="span4" style="padding-top:20px;padding-bottom:20px;">
                ...
                <li style="background: url(<?php echo base_url();?>assets/img/bullet.png) no-repeat 5px 2px;padding-left:20px"><a href="<?php echo base_url();?>assets/admission-enquiry.php"  style="color:black" target="_blank"><h5 style="color:black;padding-left:15px;">  Apply Admission</h5></a></li>
                    ...
                    <ul style="color:red;padding:10px;text-align:center" class="text-center"><li style="background: url(<?php echo base_url();?>assets/img/bullet.png) no-repeat 5px 2px;padding-left:20px"><a href="#"  style="color:black"><h5 style="color:black;padding-left:15px;"> Datesheet</h5></a></li>
                    <hr>
                <li style="background: url(<?php echo base_url();?>assets/img/bullet.png) no-repeat 5px 2px;padding-left:20px"><a href="#"  style="color:black"><h5 style="color:black;padding-left:15px;">  Practical Syllabus</h5></a></li>
                    <hr>
        ...
        <hr/>
        <div class="row" >
        <div class="span6"><img src="<?php echo base_url();?>assets/img/flag.gif"/></div>
        <div class="span6"><img src="<?php echo base_url();?>assets/img/flag1.png" style="height:150px"/></div>
        </div>
        ...
        <div class="flex-viewport" style="overflow: hidden;position: relative;">
                <ul class="slides clients" style="width: 2000%; transition-duration: 0.6s; transform: translate3d(0px, 0px, 0px);">
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/1.png" alt=""/></li>
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/2.png" alt=""/></li>    
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/3.png" alt=""/></li>
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/4.png" alt=""/></li>
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/5.png" alt=""/></li>
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/6.png" alt=""/></li>
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/7.png" alt=""/></li>
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/8.png" alt=""/></li>
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/9.png" alt=""/></li>
                    <li style="width: 160.2px; float: left; display: block;"><img src="<?php echo base_url();?>assets/img/logos/10.png" alt=""/></li>       
                </ul>
