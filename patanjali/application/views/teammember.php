...
<?php $this->load->view('header'); ?>
		...
		<div class="row">
		<div class="span12">
		<h3 style="color:white;background:#21186E;text-align:center;padding:4px;margin-bottom:20px">Our Management Team & Staff </h3>
		</div>
							<div class="span4"></div>
	      ...
	      <div class="row">	
            <div class="title"><h3>Our Team Members</h3></div>		  
			<!-- start: Flexslider -->
		...
		<div class="span3" style="text-align:center">
            ...
            <div class="row">	
            <div class="title"><h3>Our Counseling & Telecalling Team Members</h3></div>		  
			<!-- start: Flexslider -->
			<div class="span3" style="text-align:center">
			<div style="background:#e4e7ed;padding:30px;margin:10px">
					<img style="border:4px dotted #00A859;border-radius:50%" src="<?php echo base_url();?>assets/assets/img/logoh.jpg">
		...
		<div class="span3" style="text-align:center">
			...
			<div class="title"><h3>Our Technical & Advisory Body</h3></div>		  
			<!-- start: Flexslider -->
			<div class="span3" style="text-align:center">
			<div style="background:#e4e7ed;padding:30px;margin:10px">
					<img style="border:4px dotted #00A859;border-radius:50%" src="<?php echo base_url();?>assets/img/logoh.jpg">
