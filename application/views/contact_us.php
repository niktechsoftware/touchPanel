...
<li style="background: url(img/bullet1.gif) no-repeat 5px 2px;padding-left:20px"><a href="all-centers.html"  style="color:black" ><p style="color:black;padding-left:15px;font-weight:600;margin-top:10px">All Centers</p></a></li>
					...
					<fieldset>
						  ...
						  <div class="clearfix">
							...
							<div class="clearfix">
								...
								<div class="input">
									<select class="form-control"  name="state" style="width:95%;height:30px">
    <option value="">-Select State-</option>
            ...
            <span style="font-size:18px;color:white;padding-left:10px"> <strong>OPERATIONAL & REGIONAL OFFICE       &nbsp&nbsp&nbsp&nbsp        </strong></span><br/>
			<i class="fa fa-map-marker" style="font-size:20px;color:white"></i>
			<span style="font-size:16px;color:white;padding-left:6px"> G-29/9, Sector 3, Rohini, New Delhi-85&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp </span><br/>
 ...
 <i class="fa fa-envelope" style="font-size:20px;color:white"></i><span style="font-size:18px;color:white;padding-left:10px"> Director Email: director@ruralurbanskills.edu.in
            ...
            <i class="fa fa-phone-square" style="font-size:20px;color:white"></i><span style="font-size:18px;color:white;padding-left:10px">Ms. Shalu  09899822580</span><br/>
               <i class="fa fa-phone-square" style="font-size:20px;color:white"></i><span style="font-size:18px;color:white;padding-left:10px">For Verification 09873732763 </span><br/>
             <i class="fa fa-phone-square" style="font-size:20px;color:white"></i><span style="font-size:18px;color:white;padding-left:10px">Complaint & Issues. 08368919325</span>&nbsp&nbsp </br></br>
