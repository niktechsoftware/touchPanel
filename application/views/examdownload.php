...
<div class="container">		<div class="row">		<div class="span12 text-center" ><h3 style="background:#FEC400;color:white;padding:8px;">Important Examination Download Zone</h3><div class="table-responsive" style="margin-top:20px;font-size:14px">   <table class="table table-bordered">    <thead>      <tr class="colorb">        <th class="text-center"><h4>Sr. No</h4></th>        <th  class="text-center"><h4>Name Of Documents<h4/></th>        <th class="text-center"><h4>Download Links</h4></th>      </tr>    </thead>    <tbody>
...
<td><a href="http://www.ruralurbanskills.edu.in/downloads/datesheet/dec2018/RUCSVS-Dec-2018-Examination-Datesheet.pdf"  ><i class="fa fa-download" aria-hidden="true"></i> Download Now</a></td>  
 ...
 <tr>        
 <td>5.</td>       
  <td><p>RUCSVS-Delhi Dec Exam Notice 2018</p></td>        
  <td><a href="http://www.ruralurbanskills.edu.in/downloads/Dec-Exam-Notice-2018-RUCSVS-Delhi.jpg" ><i class="fa fa-download" aria-hidden="true"></i> Download Now</a></td>     
  </tr>	  
